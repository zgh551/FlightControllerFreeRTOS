  ...
  else if ((SDIO_STD_CAPACITY_SD_CARD_V1_1 == CardType) || (SDIO_STD_CAPACITY_SD_CARD_V2_0 == CardType) || (SDIO_HIGH_CAPACITY_SD_CARD == CardType))
  {
    ...
    else if (SDIO_BusWide_4b == WideMode)
    {
      ...
      if (SD_OK == errorstatus)
      {
        ...
        SDIO_InitStructure.SDIO_HardwareFlowControl = SDIO_HardwareFlowControl_Enable;//change
        SDIO_Init(&SDIO_InitStructure);
      }
    }
    else
...
//	}else
//	{
//		if(cnt==1)sta=SD_WriteBlock(buf,lsector,512);    	//μ￥??sectorμ?D′2ù×÷
//		else sta=SD_WriteMultiBlocks(buf,lsector,512,cnt);	//?à??sector  
//	}
//	return sta;
//}
/**
