...
//usefull micro
#define RADIO_EN_CSN  GPIO_ResetBits(nRF24L01_SPI_CSN_GPIO_PORT, nRF24L01_SPI_CSN_PIN)//0
#define RADIO_DIS_CSN GPIO_SetBits  (nRF24L01_SPI_CSN_GPIO_PORT, nRF24L01_SPI_CSN_PIN)//1
#define RADIO_DIS_CE  GPIO_ResetBits(nRF24L01_SPI_CE_GPIO_PORT, nRF24L01_SPI_CE_PIN)  //0
#define RADIO_EN_CE   GPIO_SetBits  (nRF24L01_SPI_CE_GPIO_PORT, nRF24L01_SPI_CE_PIN)  //1
